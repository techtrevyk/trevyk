      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-[#B9A6D1] text-base sm:text-lg leading-relaxed">
            Kiduart demos for schools, or custom IT work for your organisation.
            Choose a lane below we reply within one business day.
          </p>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 rounded-3xl bg-[#1E1024] border border-[#6B4A87]/40 shadow-2xl relative">
            {submitted ? (
              <div className="text-center py-16 space-y-4">
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-[#2A1830] border border-[#6B4A87]/40 text-xs font-mono-accent text-[#6B4A87] hover:bg-[#1E1024] transition-colors"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Inquiry Type Toggle */}
                <div>
                  <label className="block text-xs font-mono-accent text-[#B9A6D1] mb-2 uppercase">
                    I AM INTERESTED IN:
                  </label>
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border text-xs font-mono-accent flex items-center justify-center space-x-2 transition-all ${
                        formType === "services"
                          ...
                          : "bg-[#1E1024] text-[#B9A6D1] border-[#6B4A87]/40 hover:border-[#6B4A87]"
                      }`}
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-[#1E1024] border border-[#6B4A87]/40 text-[#F8F6FB] placeholder-[#B9A6D1]/45 text-xs sm:text-sm focus:outline-none focus:border-[#E8A9C2]"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-[#1E1024] border border-[#6B4A87]/40 text-[#F8F6FB] text-xs sm:text-sm focus:outline-none focus:border-[#E8A9C2] resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#6B4A87] to-[#E8A9C2] text-[#F8F6FB] font-heading font-semibold text-xs sm:text-sm shadow-xl hover:opacity-95 transition-opacity flex items-center justify-center space-x-2 disabled:opacity-50"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 sm:p-8 rounded-3xl bg-[#1E1024] border border-[#6B4A87]/35 space-y-5">
              <h3 className="font-heading font-bold text-lg text-[#F8F6FB]">
                Direct Contacts & Support
              </h3>

              <div className="space-y-4 text-xs">
                <div className="flex items-start space-x-3 text-[#B9A6D1]">
                  <div className="w-8 h-8 rounded-lg bg-[#2A1830] border border-[#6B4A87]/40 flex items-center justify-center text-[#6B4A87] shrink-0">
                    <Mail className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-[#B9A6D1] font-mono-accent text-[11px]">
                      GENERAL INQUIRIES
                    </div>
                    <a
                      href="mailto:contact@trevyk.com"
                      className="font-mono-accent text-[#6B4A87] hover:underline text-sm"
                    >
                      contact@trevyk.com
                    </a>
                  </div>
                ...
                <div className="flex items-start space-x-3 text-[#B9A6D1]">
                  ...
                  <div>
                    <div className="text-[#B9A6D1] font-mono-accent text-[11px]">
                      KIDUART / PRODUCT DESK
                    </div>
                    <a
                      href="tel:+919217534128"
                      className="font-mono-accent text-[#F8F6FB] text-sm hover:text-[#6B4A87]"
                    >
                      +91 92175 34128
                    </a>
                  </div>
                ...
                <div className="flex items-start space-x-3 text-[#B9A6D1]">
                  ...
                  <div>
                    ...
                    <span className="text-[#B9A6D1] leading-relaxed block mt-0.5">
                      Noida, Uttar Pradesh demos, rollout, and support with the
                      same team that ships{" "}
                      <a
            ...
            <div className="p-6 rounded-3xl bg-[#1E1024] border border-[#6B4A87]/35 space-y-2">
              ...
              <p className="text-xs text-[#B9A6D1] leading-relaxed">
                ...
                requests are reviewed by Trevyk no invented SLAs, no queue
                theatre.
              </p>
            </div>

            {/* Core Block Settling Cue */}
            <div className="p-5 rounded-2xl bg-[#1E1024]/80 border border-[#6B4A87]/30 flex items-center space-x-3">
              <Layers className="w-5 h-5 text-[#E8A9C2] shrink-0" />
              <div className="text-xs text-[#B9A6D1]">
                <strong className="text-[#F8F6FB] block font-heading font-semibold">
                  Architectural Journey Complete
                </strong>
                The 3D Core Block rests in full assembly. Let’s translate your
                institutional vision into code.
              </div>
            </div>
          </div>
        </div>
