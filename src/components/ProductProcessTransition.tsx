...
export const ProductProcessTransition: React.FC<ProductProcessTransitionProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-10 flex items-center space-x-2 px-3.5 py-1 rounded-full bg-[#FFFFFF]/90 border border-[#6B4A87]/60 shadow-[0_4px_16px_rgba(107,74,135,0.12)]">
