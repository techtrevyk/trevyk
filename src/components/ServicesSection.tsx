  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#6B4A87]/25 via-[#F7F4FA]/40 to-transparent blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-8 sm:pb-12 border-b border-[#6B4A87]/30">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="font-mono-accent text-xs text-[#5C4A6E] bg-[#F7F4FA]/80 px-3.5 py-2 rounded-xl border border-[#6B4A87]/40 flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`p-3 rounded-xl border transition-all ${
                  canScrollLeft
                    ? 'bg-[#F7F4FA] border-[#6B4A87]/60 text-[#241428] hover:border-[#E8A9C2] hover:bg-[#6B4A87]/30'
                    : 'bg-[#FFFFFF] border-[#6B4A87]/20 text-[#5C4A6E]/30 cursor-not-allowed'
                }`}
              >
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs sm:text-sm font-heading font-medium transition-all whitespace-nowrap interactive-target ${
                  isActive
                    ? 'bg-gradient-to-r from-[#6B4A87] to-[#B9A6D1] text-[#241428] shadow-[0_4px_16px_rgba(107,74,135,0.4)]'
                    : 'bg-[#F7F4FA]/70 text-[#5C4A6E] border border-[#6B4A87]/30 hover:border-[#B9A6D1]/60 hover:text-[#241428]'
                }`}
