...
export const ScrollProgressNav: React.FC<ScrollProgressNavProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-2.5 rounded-full bg-[#FFFFFF]/85 border border-[#6B4A87]/40 shadow-[0_10px_35px_rgba(107,74,135,0.12)] backdrop-blur-md flex flex-col items-center space-y-3 relative">
                ...
                <AnimatePresence>
                  {isHovered && (
                    <motion.div
                      ...
                      className="absolute right-9 px-3 py-1.5 rounded-xl bg-[#FFFFFF]/95 border border-[#E8A9C2]/40 text-[#241428] shadow-[0_8px_25px_rgba(107,74,135,0.16)] backdrop-blur-md flex items-center space-x-2 whitespace-nowrap pointer-events-none"
                    >
