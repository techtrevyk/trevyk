...
export const AboutTeaser: React.FC<AboutTeaserProps> = () => {
  return (
    <section
      id="about-teaser"
      className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white rounded-3xl border border-[#8B5CAD]/30 my-8 shadow-xl overflow-hidden"
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-6 relative">
          <div className="rounded-2xl border border-[#8B5CAD]/25 bg-[#F7F4FA] p-8 sm:p-12 flex flex-col items-center text-center gap-5">
            ...
            <div className="flex flex-wrap justify-center gap-2 text-[10px] font-mono-accent uppercase tracking-wider text-[#8B5CAD]">
              <span className="px-2.5 py-1 rounded-full bg-white border border-[#8B5CAD]/25">Noida, India</span>
              <span className="px-2.5 py-1 rounded-full bg-white border border-[#8B5CAD]/25">B2B + B2C</span>
              <span className="px-2.5 py-1 rounded-full bg-white border border-[#8B5CAD]/25">Honest claims only</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 w-full">
            <div className="p-3.5 rounded-xl bg-[#F7F4FA] border border-[#8B5CAD]/30">
              <GraduationCap className="w-4 h-4 text-[#8B5CAD] mb-2" />
            ...
            <div className="p-3.5 rounded-xl bg-[#F7F4FA] border border-[#8B5CAD]/30">
              <Briefcase className="w-4 h-4 text-[#8B5CAD] mb-2" />
          ...
          <div className="mt-8">
            <Link
              ...
              className="inline-flex items-center space-x-2 px-5 py-3 rounded-full bg-[#F7F4FA] border border-[#8B5CAD]/40 hover:border-[#E8A9C2] text-[#241428] font-heading text-xs sm:text-sm font-semibold hover:bg-white transition-all group"
            >
              <span>Read our story</span>
              <ArrowRight className="w-4 h-4 text-[#8B5CAD] group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
        </div>
      </div>
