        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            ...
            <p className="mt-4 text-[#B9A6D1] text-sm sm:text-base leading-relaxed">
              Trevyk structures software as independent layers with explicit
              boundaries — so Kiduart modules and client systems share the same
              resilience model: change one domain without cascading risk across
              the platform.
            </p>
            ...
            <div className="mt-5 flex items-start gap-2.5 text-xs text-[#E7E1F0] bg-[#2A1830]/80 border border-[#6B4A87]/40 rounded-xl px-3.5 py-3">
              ...
              <span>
                Inspect live tiers in the hero core, then open the full
                technology brief for how we isolate, observe, and recover.
              </span>
            </div>
