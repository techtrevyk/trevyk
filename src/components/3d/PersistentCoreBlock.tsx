...
const CUBE_CONFIGS = [
  ...
  { id: 1, label: 'API Gateway', targetPos: [0.85, 0.85, -0.15], color: '#B9A6D1', emissive: '#8F719A', accent: false }, // Top-Right (Lavender)
  { id: 2, label: 'Distributed Services', targetPos: [0, 0.15, 0], color: '#6B4A87', emissive: '#6B4A87', accent: false }, // Center Junction (Royal purple)
