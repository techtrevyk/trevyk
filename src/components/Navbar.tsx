    ...
    <>
      <header
        ...
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          scrolled
            ? 'bg-[#FFFFFF]/95 backdrop-blur-lg border-b border-[#8B5CAD]/25 py-3 shadow-[0_8px_24px_rgba(139,92,173,0.08)]'
      ...
      >
        <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav 
            className="hidden lg:flex items-center space-x-1 xl:space-x-1.5 bg-[#FFFFFF]/85 backdrop-blur-md px-3.5 xl:px-4 py-1.5 rounded-full border border-[#8B5CAD]/40 shadow-inner"
              ...
              return (
                <NavLink
                  ...
                  className={`relative px-2.5 xl:px-3.5 py-1.5 rounded-full text-xs xl:text-[13px] font-medium transition-all flex items-center space-x-1.5 group shrink-0 ${
                    isActive
                      ? 'text-[#241428] bg-[#EDE8F3] border border-[#8B5CAD]/55 shadow-[0_0_16px_rgba(139,92,173,0.35)]'
                ...
                >
                  ...
                  {link.badge && (
                    <span className={`text-[9px] xl:text-[10px] uppercase font-mono-accent px-1.5 py-0.2 rounded border ${
                      isActive
                        ? 'bg-[#8B5CAD] text-white font-bold border-[#8B5CAD]'
                        : 'bg-[#8B5CAD]/15 text-[#8B5CAD] border-[#8B5CAD]/40'
                    }`}>
                      {link.badge}
                    </span>
                  )}
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#8B5CAD]"
          ...
          <div className="hidden lg:flex items-center space-x-2 xl:space-x-3">
            ...
            {onOpenGeminiChat && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-full bg-[#FFFFFF]/80 border border-[#8B5CAD]/40 text-xs font-mono-accent text-[#8B5CAD] hover:bg-[#EDE8F3] hover:border-[#E8A9C2]/50 flex items-center space-x-1.5 transition-all"
            ...
            <button
              ...
              className={`p-2 rounded-full border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A9C2] ${
                settings.soundEnabled
                  ...
                  : 'bg-[#FFFFFF]/80 border-[#8B5CAD]/40 text-[#5C4A6E] hover:text-[#E8A9C2]'
              }`}
            ...
            <button
              ...
              className="p-2 rounded-full bg-[#FFFFFF]/80 border border-[#8B5CAD]/40 text-[#5C4A6E] hover:text-[#E8A9C2] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A9C2] transition-colors"
            ...
            >
              <Layers className="w-3.5 h-3.5 mr-1 text-white" />
          ...
          <div className="flex items-center space-x-2 lg:hidden">
            ...
            <button
              ...
              className={`p-2 rounded-xl border transition-all ${
                settings.soundEnabled
                  ...
                  : 'bg-[#FFFFFF]/80 border-[#8B5CAD]/40 text-[#5C4A6E]'
              }`}
            >
              {settings.soundEnabled ? <Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
            </button>
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[#FFFFFF]/90 border border-[#8B5CAD]/50 text-[#241428] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8A9C2] active:scale-95 transition-transform"
            >
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-30 lg:hidden flex flex-col">
            ...
            <motion.div
              ...
              className="relative w-full bg-[#FFFFFF] border-b border-[#8B5CAD]/40 shadow-2xl pt-20 pb-8 px-4 sm:px-6 max-h-[92vh] overflow-y-auto"
            >
              {/* Brand Tagline in Drawer Header */}
              <div className="mb-4 pb-3 border-b border-[#8B5CAD]/30 flex items-center justify-between">
                <span className="text-[11px] font-mono-accent uppercase tracking-wider text-[#5C4A6E]">
                  Turning Vision Into Progress.
                </span>
                <span className="text-[10px] font-mono-accent text-[#8B5CAD] bg-[#F7F4FA] px-2 py-0.5 rounded border border-[#8B5CAD]/40">
                  v3.0 Multi-Page
                </span>
              </div>
                      ...
                      <NavLink
                        ...
                        className={`flex items-center justify-between p-3 rounded-xl border text-sm font-medium transition-all group ${
                          isActive
                            ...
                            : 'bg-[#FFFFFF]/60 hover:bg-[#F7F4FA] border-[#8B5CAD]/30 text-[#5C4A6E]'
                        }`}
                      >
                        <div className="flex items-center space-x-3">
                          {Icon && (
                            <div className={`w-7 h-7 rounded-lg flex items-center justify-center transition-transform ${
                              isActive ? 'bg-[#E8A9C2] text-[#241428]' : 'bg-[#F7F4FA] text-[#E8A9C2] border border-[#8B5CAD]/40'
                            }`}>
                          ...
                          <span>{link.label}</span>
                          {link.badge && (
                            <span className="text-[9px] uppercase font-mono-accent px-1.5 py-0.5 rounded bg-[#8B5CAD]/50 text-[#E8A9C2]">
                              {link.badge}
                            </span>
                          )}
                        </div>
              ...
              <div className="mt-5 pt-4 border-t border-[#8B5CAD]/30 space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  <button
                    ...
                    className="flex items-center justify-between text-xs text-[#5C4A6E] p-3 rounded-xl bg-[#FFFFFF]/80 border border-[#8B5CAD]/30"
                  >
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#8B5CAD] via-[#A078C8] to-[#E8A9C2] text-[#241428] font-heading font-semibold text-sm flex items-center justify-center space-x-2 shadow-[0_10px_25px_rgba(139,92,173,0.4)] active:scale-[0.99] transition-transform"
                >
