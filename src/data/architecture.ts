...
export const ARCHITECTURE_CUBES: ArchitectureCubeItem[] = [
  {
    ...
    techStack: ['CDN / reverse proxy', 'TLS 1.2+', 'Brotli / gzip', 'DNS failover'],
  },
  {
    id: 'api-gateway',
    ...
    techStack: ['API gateway / BFF', 'JWT or session cookies', 'RBAC policies', 'Redis (optional cache)'],
  },
  {
    ...
    techStack: ['Node / TypeScript', 'containers', 'queues', 'structured logging'],
  },
  {
    id: 'modular-erp-core',
    ...
    techStack: ['TypeScript', 'PostgreSQL', 'web + mobile clients', 'payment gateways'],
  },
  {
    ...
    techStack: ['PostgreSQL', 'object storage', 'backup tooling', 'encryption at rest'],
  },
];
